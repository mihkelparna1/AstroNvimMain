...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>gg"] = { function() require("telescope.builtin").live_grep() end, desc = "Find words" }
  maps.n["<leader>Gg"] = {
    function()
...
if is_available "toggleterm.nvim" then
  maps.n["<leader>aa"] = sections.t
  if vim.fn.executable "lazygit" == 1 then
    maps.n["<leader>g"] = sections.g
    maps.n["<leader>git"] = { function() utils.toggle_term_cmd "lazygit" end, desc = "ToggleTerm lazygit" }
  ...
  maps.n["<leader>aa"] = { "<cmd>ToggleTerm size=10 direction=horizontal<cr>", desc = "ToggleTerm horizontal split" }
  maps.t["<F7>"] = maps.n["<F7>"]
  maps.n["<C-'>"] = maps.n["<F7>"]
  maps.t["<C-'>"] = maps.n["<F7>"]
end
